...
## Setup Instructions:
> **Quick Start:** Follow these steps to get the environment running on your local machine.


### The prerequisites are as follows:
**JDK:** Java 17 or Higher (we used JDK 17).
...
git init
```
This Git command is used to connect your local repository to a remote repository.
```bash
git remote add origin https://github.com/tranished-mase/SpringAssignment1.git
```
This command is used to update your current local branch with the latest changes from a remote server.
```bash
...
Execute the Demo2Application.java file from your IDE.
